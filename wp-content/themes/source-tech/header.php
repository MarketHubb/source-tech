...
<body <?php body_class(); ?>>
	...
	<?php if (is_page(777) || is_singular('networking') || is_singular('servers') || is_singular('storage') || is_page(2055) || is_page(661) || is_page(2415) || is_page(2488) || is_category() || is_page(577) ) { ?>
