    ...
    <div class="wrapper">
        <div class="row content">
            <div class="col-md-12 text-center mb-3">
                ...
                <p>Including how we ship, what payment methods we take, and much more</p>
            </div>
            <?php
...
//                    $faq .= '<p class="lead font-weight-bold mb-0 pb-0">' . get_sub_field($faq_sub_field_question, 'option') . '</p>';
                    $faq .= '<p class="font-weight-bold lh-sm  pb-0">' . replace_product_variable_in_string(get_sub_field($faq_sub_field_question, 'option'), $post->ID) . '</p>';
